...
define(function(require, exports, module) {
    ...
    var page22And23Model = { popups: [
            ...
            {name: 'main_pirate', timer: this, url: '/content/images/pages/22and23/main_pirate.png', rotate: true, rotateAngle: 20, rotateSpeed: 2000},
            {name: 'charlie', timer: this, url: '/content/images/pages/22and23/charlie.png', rotate: true, rotateAngle: 10, rotateSpeed: 2000},
